...
export default function HeroSection({ homePage }: HeroSectionProps) {
  ...
  // @ts-ignore
  return (
    <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-center max-w-7xl mx-auto">
      {/* Left Content */}
      ...
      {/* Right Advertisement */}
      <div className="w-full lg:w-1/2 rounded-2xl bg-[#fffdf4] sm:max-w-md md:w-auto h-full md:h-72 overflow-hidden">
        {ads.length > 0 && false ? (
          <div
